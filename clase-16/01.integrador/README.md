...
Logger super performante para almacenar en un archivo o base datos los errores y su criticidad.

<https://getpino.io/>

- estructura JSON
- Muy rápido
- Ideal para servicios Rest API

* fatal | 60 | La app no puede seguir
* error | 50 | Error grave, pero el proceso sigue
* warn | 40 | Algo anda mal, pero no rompió
* info | 30 | Eventos normales del sistema
* debug | 20 | información detallada para desarrollo -> no se loggea
* trace | 10 | Detalle extremo (muy verboso) -> no se loggea

# Validaciones rápidas con express validator
